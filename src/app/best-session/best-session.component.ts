...
@Component({
  selector: 'app-best-session',
  templateUrl: './best-session.component.html',
  styleUrls: ['./best-session.component.css']
})
export class BestSessionComponent implements OnInit {
  ...
  matInfo : any;
  selectedLevel:any;
  startDate : any = "2020-07-13";
  dt = new Date();
  endDate : any = "2020-07-19";
  totalData : number = 0;
  recordPerPage : any = 10;
  currentPage : number = 1;
  totalPages : any = 1;
  fileName = "bestsession.xlsx";
  ...
  ngOnInit(): void {
    ...
    if(this.cookieValue == ""){
      ...
      this.service.getBestSession(this.startDate,this.endDate,this.currentPage, this.search , keyword).subscribe(res=>{
        this.resp = res;
  ...
  exportexcel(){
    ...
    if(keyword != ''){
      ...
      for (let index = 1; index <= this.totalPages; index++) {
        ...
        this.service.getBestSession(this.startDate,this.endDate,index,this.search,keyword ).subscribe(res=>{
          this.resp = res;
